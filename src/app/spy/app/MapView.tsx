...
// Wraps any media element with mouse-wheel + pinch zoom + drag-to-pan.
// Scale clamped to [1, 8]; pan clamped so the media never leaves the frame entirely.
...
function CameraOverlay({ cam, onClose }: { cam: Camera; onClose: () => void }) {
  ...
  return (
    <div
      className="fixed inset-0 z-[2000] flex flex-col bg-black/95 backdrop-blur"
      onClick={onClose}
    >
