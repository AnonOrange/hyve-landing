        ...
        <div className="hyve-card rounded-3xl p-10 md:p-14 text-center relative overflow-hidden gold-glow">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-xl mx-auto mb-10">
              ...
              {/* iOS — Request Early Access */}
              <a
                href={iosUrl}
                className="hyve-card rounded-2xl p-5 flex flex-col items-center gap-2 cursor-pointer hover:border-white/20 transition-colors"
              >
                ...
                <span className="font-bold text-sm text-white/40">iOS App</span>
                <span className="text-xs text-white/30">Request Early Access</span>
              </a>
            </div>
